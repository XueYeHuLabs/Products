...
[下载最新版本 / Latest Release](./../../releases/latest)
|
...
|
[官方站点 / Official Site](https://snowwildfox.com/)
...
- README 中的下载入口直接指向 `Latest Release`
- 如版本页面提供校验文件，可一并下载用于完整性校验

如果你是从 GitHub 仓库首页进入，推荐直接点击上方“下载最新版本 / Latest Release”。
...
4. 先在 `Credentials` 页面创建凭据。
5. 返回 `Session` 页面，选择凭据并填写显示参数。
6. 点击 `Start Session` 启动会话，再通过 `Create Process` 和 `Link Session` 进入环境。
...
[Latest Release / 下载最新版本](./../../releases/latest)
|
...
[English Changelog](./docs/changelog.en.md)
|
[Official Site / 官方站点](https://snowwildfox.com/)
...
If you arrived from the GitHub repository homepage, the recommended entry is the "Latest Release / 下载最新版本" link above.
